...
| :--------: | :-------: | :-------------: | :-------: | :-----: | :-------: | :------: | :---: | :-----------------------------------------------------------------: | :-------------------------------------------------------------------: | :--------------------------: |
| Cityscapes | PointRend | DCFFResNetV1c50 | 512x1024  |  160k   |   18.43   |  74410   | 76.75 | \[0.0, 0.0, 0.0\] + \[0.35, 0.4, 0.1\] * 10 + \[0.3, 0.3, 0.1\] * 6 | [config](../../mmseg/dcff/dcff_pointrend_resnet50_8xb2_ade20k.py) | [model](<>) \| \[log\] (\<>) |
...
python tools/pruning/get_channel_units.py
  configs/pruning/mmseg/dcff/dcff_pointrend_resnet50_8xb2_ade20k.py \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 PORT=29500 ./tools/dist_train.sh \
  configs/pruning/mmseg/dcff/dcff_pointrend_resnet50_8xb2_ade20k.py 4 \
  --work-dir $WORK_DIR
```
