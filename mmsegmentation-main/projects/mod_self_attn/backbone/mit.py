...
from ..utils.mod_mha import ModifiedMultiheadAttention
...
class MultiheadAttentionModified(BaseModule):
    ...
    def __init__(self,
        ...
        self.attn = ModifiedMultiheadAttention(embed_dims, num_heads)
...
class EfficientMultiheadAttention(MultiheadAttentionModified):
...
class MixVisionTransformerModMha(BaseModule):
