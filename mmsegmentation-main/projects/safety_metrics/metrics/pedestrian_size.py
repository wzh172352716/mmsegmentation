...
class PedestrianDistanceMetric(BaseMetric):
    ...
    def process(self, data_batch: dict, data_samples: Sequence[dict]) -> None:
        ...
        for data_sample in data_samples:
            ...
            # 查找漏检和检测到的行人
            missed_pedestrians, detected_pedestrians, false_positives = self.visualize_missed_pedestrians(
                original_img, 
                label_pedestrian,
            ...
            # # 处理误检的行人
            # if false_positives:
            #     self.false_pedestrians_dict[basename] = false_positives
        ...
        #     # 保存误检行人信息
        #     false_output_file_path = osp.join(self.output_dir, "false_pedestrians.json")
        #     with open(false_output_file_path, 'w') as f:
        #         json.dump(self.false_pedestrians_dict, f, indent=4)
    ...
    def visualize_missed_pedestrians(self, img, label_pedestrian, pred_label_pedestrian,
        ...
        return missed_pedestrians, detected_pedestrians, false_positives
