...
compressed_height = 335
compression_rate = 4.08
crop_size = (1564, compressed_height)
...
model = dict(
    ...
    test_cfg=dict(mode='slide', crop_size=(compressed_height, 1564), stride=(768, 768)))
...
test_pipeline = [
    ...
    distort_cfg,
    dict(type='Resize', scale=(1564, compressed_height), keep_ratio=False),
