...
compressed_height = 295
compression_rate = 4.912
crop_size = (1773, compressed_height)
...
model = dict(
    ...
    resize=(compressed_height, 2048),
    data_preprocessor=data_preprocessor,
    backbone=dict(init_cfg=dict(type='Pretrained', checkpoint=checkpoint)),
    test_cfg=dict(mode='slide', crop_size=(compressed_height, 1773), stride=(768, 768)))
...
test_pipeline = [
    ...
    distort_cfg,
    dict(type='Resize', scale=(1773, compressed_height), keep_ratio=False),
