...
compressed_height = 724
compression_rate = 0.808
crop_size = (1448, compressed_height)
...
model = dict(
    ...
    test_cfg=dict(mode='slide', crop_size=(compressed_height, 1448), stride=(768, 768)))
...
test_pipeline = [
    ...
    distort_cfg,
    dict(type='Resize', scale=(1448, compressed_height), keep_ratio=False),
