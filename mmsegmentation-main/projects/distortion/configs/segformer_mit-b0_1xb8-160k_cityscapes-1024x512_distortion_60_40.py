...
compressed_height = 418
compression_rate = 2.86
crop_size = (1254, compressed_height)
...
model = dict(
    ...
    test_cfg=dict(mode='slide', crop_size=(compressed_height, 1254), stride=(768, 768)))
...
test_pipeline = [
    ...
    distort_cfg,
    dict(type='Resize', scale=(1254, compressed_height), keep_ratio=False),
