...
#9 -> 186
#10 -> 170
distort_cfg = dict(type='Distortion2', size=(2048, 1024), compression_rate=compression_rate, labels=False)
model = dict(
...
train_pipeline = [
    ...
    dict(type='Distortion2', size=(2048, 1024), compression_rate=compression_rate, labels=True),
    dict(
        type='RandomResize',
