...
#9 -> 186
#10 -> 170
distort_cfg = dict(type='Distortion', size=(2048, 1024*height_resize), compression_rate=compression_rate, labels=False)
model = dict(
    type="EncoderDecoderDistort",
    distort_cfg=distort_cfg,
    data_preprocessor=data_preprocessor,
    resize_after=(1024, 2048),
...
train_pipeline = [
    ...
    dict(type='Resize', scale=(2048, 1024*height_resize), keep_ratio=False),
    dict(type='Distortion', size=(2048, 1024*height_resize), compression_rate=compression_rate, labels=True),
    dict(
        type='RandomResize',
