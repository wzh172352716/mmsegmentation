...
compressed_height = 375
compression_rate = 3.424
crop_size = (1395, compressed_height)
...
model = dict(
    ...
    test_cfg=dict(mode='slide', crop_size=(compressed_height, 1395), stride=(768, 768)))
...
test_pipeline = [
    ...
    distort_cfg,
    dict(type='Resize', scale=(1395, compressed_height), keep_ratio=False),
