...
compressed_height = 463
compression_rate = 2.392
crop_size = (1132, compressed_height)
...
model = dict(
    ...
    test_cfg=dict(mode='slide', crop_size=(compressed_height, 1132), stride=(768, 768)))
...
test_pipeline = [
    ...
    distort_cfg,
    dict(type='Resize', scale=(1132, compressed_height), keep_ratio=False),
