...
checkpoint = '/beegfs/work/bartels/mmsegmentation/pretrained_weight/segformer/mit_b0_static_pruning_mha_50.0%_round_off.pth'  # noqa
model = dict(
    data_preprocessor=data_preprocessor,
    backbone=dict(type="MixVisionTransformerStaticPruning",
                  pruning_rate_mha=0.5, init_cfg=dict(type='Pretrained', checkpoint=checkpoint)),
    decode_head=dict(
