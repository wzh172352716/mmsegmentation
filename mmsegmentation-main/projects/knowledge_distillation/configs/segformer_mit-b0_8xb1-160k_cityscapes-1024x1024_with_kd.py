...
checkpoint_teacher = '/beegfs/work/bartels/mmsegmentation/downloaded_ckpts/segformer/segformer_mit-b5_8xb1-160k_cityscapes-1024x1024.py.pth'
...
train_dataloader = dict(batch_size=1, num_workers=4, dataset=dict(type="CityscapesDataset"))
