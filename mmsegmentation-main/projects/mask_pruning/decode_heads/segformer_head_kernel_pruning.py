...
SegformerHead_Conv2d_pruned = mask_class_wrapper(ConvModule, mode="conv_kernel")
@MODELS.register_module()
class SegformerHeadKernelPruning(BaseDecodeHead):
    ...
    def __init__(self, interpolate_mode='bilinear', k=3, **kwargs):
        ...
        SegformerHead_Conv2d_pruned = mask_class_wrapper(ConvModule, mode="conv_kernel", k=k)
